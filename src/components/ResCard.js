...
const RestaurantCard = (props)=>{
    ...
    return(
      <div className="p-[10px] m-5 w-[255px] h-auto border-black border-2 shadow-3xl hover:bg-orange-100 rounded-lg">
        <div className="justify-center items-center flex-col">
          <img src={CDN_URL+cloudinaryImageId} className=" rounded-xl w-[240px] h-[200 px]"/>
        </div>
